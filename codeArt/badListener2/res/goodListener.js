function ElizaBot() {
  this.responses = [
    ...
    { pattern: /(.*)/, responses: ["$1.", "You don't make sense.", "You disgust me.", "I hate you", "I pity you, actually.", "You are a lonely creep.", "What the fuck does that mean?", "I'm not listening", "You suck", "Whatever", "Wow, that's actually not interesting at all."] },
  ];
